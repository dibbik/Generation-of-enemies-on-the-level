...
public class GameController : MonoBehaviour
{
    ...
    [SerializeField] private TargetRegistry _targetRegistry;
    [SerializeField] private HeroRegistry _heroRegistry;
    ...
    public HeroRegistry HeroRegistry => _heroRegistry;
    ...
    {
        Hero heroPrefabOfInstance = _heroCoordinator?.GetPrefabForHero(heroInstance);
        return heroPrefabOfInstance == heroPrefab;
    ...
    {
        _allEnemies.RemoveAll(enemy => enemy == null);
        return new List<Enemy>(_allEnemies);
    }
